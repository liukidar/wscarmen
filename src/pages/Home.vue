  ...
  <div>
    <div class="full-screen vertical-flex" style="overflow: hidden;">
      ...
      <div id="header" class="absolute-center-aligned vertical-flex center">
        <page-header :loaded="loaded" open-title-char='/' close-title-char='/' to="about" class="white-text text-important center-align">
        ...
        <div id="header-sidebar" class="hide-on-small-only flex-filler">
          ...
          <div class="flex-fixed hide-on-small-only">
            <capitalize-oh word="Articoli" to="articles/!" class="waves-effect waves-light"></capitalize-oh>
          </div>
          <div class="vr white flex-filler"></div>
          <div style="padding: 1rem; align-self:flex-end; transform: translateX(50%); z-index: 1"><i @click="login = !login" class="material-icons btn-hm waves-effect">person</i></div>
        </div>
      </div>
    ...
    <layer id="about" class="section">
      <div class="section" slot-scope="layer" style="margin-bottom: 0;">
        ...
        <div class="row section">
          ...
          <div class="col col-margin s12 m4 center-align">
            <span class="btn-hm dark text-important" @click="(e) => layer.set(e, 'renovation', 'white')">RISTRUTTURAZIONE</span>
          </div>
          <div class="col col-margin s12 m4 center-align">
      ...
      <div class="center-align vertical-flex" slot="renovation" slot-scope="layer">
        <div class="card-padding flex-filler background-contain">
          <div class="section">
            ...
            <div class="flow-text">
              demolire e ricostruire, mantenere e conservare, rivedere e cambiare, l’idea sviluppata che si concretizza, che segue il progetto in ogni sua fase, fino alla fine.
            </div>
          </div>
          <div style="margin: 0 auto;">
            <i class="material-icons close-arrow btn-hm dark waves-effect waves-light" @click="(e) => layer.set(e, null, 'white')">arrow_back</i>
      ...
      <div class="center-align vertical-flex" slot="building" slot-scope="layer">
        <div class="card-padding flex-filler background-contain">
          <div class="section">
            ...
            <div class="grey" style="display: inline-block; width: 28px; height: 3px; margin:4px 0 16px 0;"></div>
            <div class="flow-text">
              mattone e gesso, cemento e sabbia, ferro e legno, materiali in armonia tra loro, che si uniscono e crescono, fino alla fine dell’opera.
            </div>
          </div>
          <div style="margin: 0 auto;">
            <i class="material-icons close-arrow btn-hm dark waves-effect waves-light" @click="(e) => layer.set(e, null, 'white')">arrow_back</i>
    ...
    <paper-container id='presentation' class="section grey lighten-4">
      ...
      <div class="row horizontal-flex stretch">
        <div class="col l3 hide-on-med-and-down background-cover" style="background-image: url('static/imgs/IMG_6262.jpg'); box-shadow: inset -10px 10px 20px -10px rgba(0,0,0,1);"></div>
        <div class="section col s12 m12 l9" style="padding-top: 4rem;">
          <div class="container section" v-for="(person, index) in text.sections.about.people" :key="person.name">
            <div class="row">
              <card-person class="col s12 m11 l10" :img="'static/imgs/profile.jpg'" :title="person.name" :subtitle="person.type" :class="{'right-side': index % 2, 'offset-m1 offset-l2': !(index % 2)}">
    ...
    <paper-container id="news" class="white" style="padding-top: 20px;">
      ...
      <div class="container section center-align">
        ...
        <div class="row">
          <preview v-for="el in articles" :key="el.ID" :article="el.ID" :title="el.title" :subtitle="el.subtitle" :description="el.description" :image="el.img"></preview>
        </div>
      </div>
    </paper-container>
    <div class="black" id="infos" style="overflow:auto">
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="col s12 l5 no-margin grey darken-4 grey-text text-lighten-2 center-align vertical-flex center" style="height: 520px;">
      ...
      <form class="white-text">
        ...
        <paper-container class="grey darken-4 z-depth-3 grey-text text-lighten-2">
          <template slot="paper-before"><paper class="rt black" deg="8"></paper></template>
          <div class="row container" style="max-width: 800px; position: relative;">
            ...
            <div class="input-field col s12">
              ...
              <textarea v-model="requestMsg" id="textarea1" class="materialize-textarea white-text" style="height:108px;"></textarea>
            </div>
          </div>
        </paper-container>
        <div class="row grey darken-2">
          <div class="container">
            <p class="right-align col s12">
              <a @click="sendRequest" class="btn btn-hm waves-effect waves-light">{{text.sections.contacts.rows[1].labels[0]}} <i class="right material-icons">send</i></a>
            </p>
          </div>
        </div>
      </form>
